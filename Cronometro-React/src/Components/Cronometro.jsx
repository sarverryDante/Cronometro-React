  ...
  return (
    <>
      <div className='w3-container w3-center'>
        ...
        {/*en linea 31: el prev toma el valor de corriendo y con '!' niega el estado, cambiandolo de true a false o viseversa.
        ...
        {/*en linea 34: pone el corriendo en false detiendo el temporizador y el tiempo en 0*/}
        <button className='w3-button w3-circle w3-black' onClick={() => (setListaTiempos([...listaTiempos, formatearTiempo()]))}>Parcial</button>
        {/*en linea 36: toma el tiempo actual de 'formatearTiempo' y lo agrega al '<ul>' dentro del componente 'ListaParcial'*/}
        <h3>TIEMPOS</h3>
